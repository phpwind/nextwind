 ...
 * @version $Id: PwAttentionService.php 21192 2012-11-30 06:47:34Z jieyin $
...
class PwAttentionService {
	...
	public function addFollow($uid, $touid) {
		...
		if ($loginUser->info['recommend_friend'] ) {
			$recommendUser = $this->_getRecommendService()->attentionUserRecommend($touid);
			$dm->setRecommendFriend($recommendUser);
		}
		$dm->addFollows(1);
