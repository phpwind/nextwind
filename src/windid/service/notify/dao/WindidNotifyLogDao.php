 ...
 * @version $Id: WindidNotifyLogDao.php 21452 2012-12-07 10:18:33Z gao.wanggao $ 
 * @package 
 */
class WindidNotifyLogDao extends WindidBaseDao {

	protected $_table = 'windid_notify_log';
	protected $_pk = 'logid';
	protected $_dataStruct = array('nid', 'appid', 'complete', 'send_num', 'reason');
