 ...
 * @package wind
 */
class AppVerify_VerifyPostReplyDo extends PwPostDoBase { 
	...
	public function check($postDm) {
		if (($result = $this->_getService()->checkVerifyRights($this->loginUser->uid, AppVerify_Verify::RIGHT_POSTREPLY)) instanceof PwError) {
			return $result;
		}
		return true;
	}
