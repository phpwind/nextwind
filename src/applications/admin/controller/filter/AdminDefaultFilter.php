 ...
 * @version $Id: AdminDefaultFilter.php 21801 2012-12-13 09:31:09Z yishuo $
 * @package wind
 */
class AdminDefaultFilter extends WindActionFilter {
	...
	public function preHandle() {
		...
		if (in_array("$module/$controller/$action", array('default/index/login', 'default/index/showVerify'))) return;
		
		/* @var $userService AdminUserService */
		$userService = Wekit::load('ADMIN:service.srv.AdminUserService');
		$loginUser = Wekit::getLoginUser();
		if (!$loginUser->isExists() || !$userService->ipLegal(Wekit::app()->clientIp)) {
