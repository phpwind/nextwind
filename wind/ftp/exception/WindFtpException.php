...
class WindFtpException extends WindException {
	CONST CONNECT_FAILED = 100;
	CONST LOGIN_FAILED = 101;
	CONST LOGIN_FAILED_PASS_ERROR = 102;
	
	CONST FILE_FOBIDDEN = 110;
	CONST FILE_READ_FOBIDDEN = 115;
	CONST COMMAND_FAILED = 120;
	CONST COMMAND_FAILED_COMMUNICATE_TYPE = 121;
	CONST COMMAND_FAILED_CWD = 122;
	CONST COMMAND_FAILED_PASS_PORT = 123;
	
	CONST OPEN_DATA_CONNECTION_FAILED = 130;
