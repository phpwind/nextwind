 ...
 * @version $Id: WindWebApplication.php 3829 2012-11-19 11:13:22Z yishuo $
 * @package web
 */
class WindWebApplication extends WindModule implements IWindApplication {
	...
	public function doDispatch($forward, $display = false) {
		...
		if ($this->dispatcher === null) $this->dispatcher = $this->factory->getInstance('dispatcher');
	...
	public function getModules($name = '') {
		...
		if (!isset($_module['_verified']) || $_module['_verified'] !== true) {
			...
			$_module && $_module = WindUtility::mergeArray($this->_config['modules']['default'], $_module);
